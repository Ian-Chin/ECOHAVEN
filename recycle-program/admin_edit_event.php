...
<main>
    ...
    <div class="main_background">
        ...
        <div class="edit_form">
            ...
            <form id="edit_event_form" action="edit_event.php" method="POST" enctype="multipart/form-data">
                ...
                <table id="edit_table">
                    ...
                    <tr>
                        ...
                        <td>
                            <img id="event_image" src="uploadImage/<?php echo htmlspecialchars($row['image']); ?>" alt="Event Image" style="max-width:150px;display:block;">
                            <!-- Remove required if you want to allow keeping the old image -->
        ...
        <div class="previuos_button_class">
            <a href="recycle_admin_main.php">
                <img id="previous_page_button" src="RecyclingImages/previous-page-button.svg" alt="Previous Button">
            </a>
        </div>
