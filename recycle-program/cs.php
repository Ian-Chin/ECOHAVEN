        ...
        <div class="main_background">
            ...
            <div class="CS_class">
                <h1 id="CS_title">Collection Schedules
                    <img id=calendar_image src="RecyclingImages/calendar.png">
                </h1>
            </div>
            ...
            <div class="imp_recycle">
                <h1 id="imp_recycle_title">Importants of Recycle
                    <img id=imp_image src="RecyclingImages/important-icon.png">
                </h1>
            </div>
    
            <div class="imp_one">
                <img id=tree_image src="RecyclingImages/tree.avif">
                <div>
                    <h2 id="CNR">Conserves Natural Resources</h2>
                    <p id="CNR_p">Recycling helps conserve raw materials by reusing existing materials instead of extracting new resources. For example, recycling paper saves trees, and recycling metal reduces the need for mining new ores.</p>
                </div>
            </div>
    
            <div class="polution_class">
                <img id=polution_image src="RecyclingImages/pollution.jpg">
                <div>
                    <h2 id="polution_title">Minimizes Pollution</h2>
                    <p id="polution_p">Recycling reduces the amount of waste sent to landfills and incinerators, which helps prevent pollution. It also reduces harmful emissions from manufacturing processes by utilizing recycled rather than virgin materials.</p>
                </div>
            </div>
    
            <div class="landfill_class">
                <img id=landfill_image src="RecyclingImages/landfill-waste.jpg">
                <div>
                    <h2 id="landfill_title">Reduces Landfill Waste</h2>
                    <p id="landfill_p">Recycling helps to significantly reduce the volume of waste sent to landfills, decreasing the need for more landfill space and preventing soil and groundwater contamination.</p>
                </div>
            </div>
    
            <div class="greenhouse_class">
                <img id=greenhouse_image src="RecyclingImages/greenhouse-effect.jpg">
                <div>
            ...
            <div class="community_class">
                <img id=community_image src="RecyclingImages/community-health.jpg">
                <div>
            ...
            <div class="economy_class">
                <img id=economy_image src="RecyclingImages/economy.avif">
                <div>
            ...
            <div class="previuos_button_class">
                <a href="r.html"><img id=previous_page_button src="RecyclingImages/previuos-page-button.png"></a>
            </div>
