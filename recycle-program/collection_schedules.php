...
<head>
    ...
    <link rel="stylesheet" href="css/collection_schedules.css">
        ...
        <div class="main_background">
                        ...
                        <div class="join_recycle_card">
                            <div class="join_recycle_content">
                                ...
                                <div class="join_button_class">
                                    <a href="join_event.php?event_id=<?php echo $row['event_id']; ?>" id="join_button">Join</a>
                                </div>
                            </div>
            ...
            <footer>
                <div class="footer-content">
                    ...
                    <div class="socials">
                        <p>Social Medias</p>
                        <img src="RecyclingImages/facebookicon.ico" alt="facebook pic">
                        <img src="RecyclingImages/instaicon.ico" alt="insta pic">
                        <img src="RecyclingImages/mail.ico" alt="email pic">
                        <br><br>
