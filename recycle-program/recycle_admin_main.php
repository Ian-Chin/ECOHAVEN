                    ...
                    <?php while ($row = mysqli_fetch_assoc($result1)){ ?>
                        <tr>
                            ...
                            <td id="modify_recycle_event">
                                ...
                                <a href="admin_delete_event.php?id=<?php echo htmlspecialchars($row['event_id']); ?>" onclick="return confirm('Are you sure you want to delete this event?');">
                ...
                <table id="user_database_table">
                    ...
                    <?php while ($row = mysqli_fetch_assoc($result2)){ ?>
                        <tr>
                            ...
                            <td id="modify_recycle_event">
                            <a href="admin_edit_recycle_user.php?id=<?php echo htmlspecialchars($row['join_id']); ?>">
                                <img id="edit_icon" src="RecyclingImages/edit-icon.svg" alt="Edit">
                            </a>

                            <a href="admin_delete_join_user.php?id=<?php echo htmlspecialchars($row['join_id']); ?>">
                                <img id="delete_icon" src="RecyclingImages/delete-icon.svg" alt="Delete">
                            </a>
                            </td>
                        </tr>
