        ...
        <div class="edit_user_form">
            ...
            <form id="edit_user_form" action="edit.php" method="POST" enctype="multipart/form-data">
                ...
                <table id="edit_user_table">
                    ...
                    <tr>
                        <th>Role:</th>
                        <td><input type="text" name="role" value="<?php echo htmlspecialchars($row['role']); ?>" required></td>
                    </tr>

                    <tr>
                        <th>Status:</th>
                        <td><input type="text" name="status" value="<?php echo htmlspecialchars($row['status']); ?>" required></td>
                    </tr>
