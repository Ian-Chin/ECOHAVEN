...
<main> -->
    <!-- <section class="banner">
        <h1>ECOHAVEN</h1>
        <p>Green World!</p>
        <img src="RecyclingImages/edit-banner-background.jpeg" alt="Edit Banner Background" class="bg">
    </section> -->

    <div class="main_background">
        <div class="edit_username_content">
            ...
            <div class="edit_user_form">
                ...
                <form id="edit_user_form" action="edit.php" method="POST" enctype="multipart/form-data">
                    ...
                    <table id="edit_user_table">
                        <tr>
                            <th>Username:</th>
                            <td><input type="text" name="username" value="<?php echo htmlspecialchars($row['uid']); ?>" required></td>
                        </tr>
                        ...
                        <tr>
                            <th>Password:</th>
                            <td><input type="text" name="password" value="<?php echo htmlspecialchars($row['pwd']); ?>" required></td>
                        </tr>
