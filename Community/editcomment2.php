            ...
            <div class="your-community">
                ...
                <div class="community-cards-container">
                    <div class="community-card">
                        ...
                        echo "<form method='POST' action='".editComments2($conn)."' class='comment-section'>
                            <input type='hidden' name='cid' value='".$cid."'>
                            <input type='hidden' name='uid' value='".$uid."'>
                            <input type='hidden' name='date' value='".$date."'>
                            <textarea name='message' id='comment-input'>".$message."</textarea>
                            <button type='submit' name='commentSubmit' id='post-comment'>Edit</button>
                        </form>";
                        ?>
                    </div>
                </div>
